...
export class CUIActions<T> {
	...
	public create: (
		ctx: CUIContext,
		payload: Partial<T>
	) => Promise<T | string> | T | string = undefined;
	 ...
	 * If operating in single record mode, id will be left out
	 */
	public update: (ctx: CUIContext, id?) => Promise<T | string> | T | string = undefined;
	 ...
	 */
	public delete: (ctx: CUIContext, id?) => Promise<T | string> | T | string = undefined;
